const ServiceImagesUrl = (dynamicPath: string | undefined) => {
  ...
  // Images are inside /projects folder
  return `${cleanBase}/services/${cleanPath}`;
};

export default ServiceImagesUrl;
