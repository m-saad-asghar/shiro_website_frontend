  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        >
          {/* Map */}
          <div className="w-full h-[400px] md:h-[500px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
            <iframe
          ...
          >
            ...
            <button
              className="w-full mt-4 bg-primary text-white font-semibold py-3 px-4 rounded-lg hover:bg-[#9f8151] transition-all duration-[.4s] flex items-center justify-center gap-2"
              onClick={() =>
                window.open(
