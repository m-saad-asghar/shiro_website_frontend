...
const FooterSocialMedia = () => {
  const data: FooterSocialMediaType[] = useMemo(
    () => [
      {
        id: 1,
        icons: <Icons.FaFacebook size={30} color="#ffff" />,
        link: "https://www.facebook.com/shiroestate",
      },
      {
        id: 2,
        icons: <Icons.FaInstagram size={30} color="#ffff" />,
        link: "https://www.instagram.com/shiro.estate/",
      },
      {
        id: 3,
        icons: <Icons.FaLinkedin size={30} color="#ffff" />,
        link: "https://www.linkedin.com/company/shiro-estate/",
      },
      {
        id: 4,
        icons: <Icons.FaTiktok size={30} color="#ffff" />,
        link: "https://www.tiktok.com/@shiroestate",
      },
      {
        id: 5,
        icons: <Icons.FaSnapchatGhost size={30} color="#ffff" />,
